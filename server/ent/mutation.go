...
func (m *BookMutation) AddRefereeIDs(ids ...int) {
	if m.referees == nil {
...
// ClearReferees clears the "referees" edge to the Book entity.
func (m *BookMutation) ClearReferees() {
	m.clearedreferees = true
}

// RefereesCleared reports if the "referees" edge to the Book entity was cleared.
func (m *BookMutation) RefereesCleared() bool {
	return m.clearedreferees
}

// RemoveRefereeIDs removes the "referees" edge to the Book entity by IDs.
func (m *BookMutation) RemoveRefereeIDs(ids ...int) {
...
// RemovedReferees returns the removed IDs of the "referees" edge to the Book entity.
func (m *BookMutation) RemovedRefereesIDs() (ids []int) {
...
func (m *BookMutation) RefereesIDs() (ids []int) {
...
func (m *BookMutation) ResetReferees() {
	m.referees = nil
...
func (m *BookMutation) AddReferenceIDs(ids ...int) {
	if m.references == nil {
...
// ClearReferences clears the "references" edge to the Book entity.
func (m *BookMutation) ClearReferences() {
	m.clearedreferences = true
}

// ReferencesCleared reports if the "references" edge to the Book entity was cleared.
func (m *BookMutation) ReferencesCleared() bool {
	return m.clearedreferences
}

// RemoveReferenceIDs removes the "references" edge to the Book entity by IDs.
func (m *BookMutation) RemoveReferenceIDs(ids ...int) {
...
// RemovedReferences returns the removed IDs of the "references" edge to the Book entity.
func (m *BookMutation) RemovedReferencesIDs() (ids []int) {
...
func (m *BookMutation) ReferencesIDs() (ids []int) {
...
func (m *BookMutation) ResetReferences() {
	m.references = nil
...
func (m *BookMutation) AddedEdges() []string {
	...
	if m.referees != nil {
		edges = append(edges, book.EdgeReferees)
	}
	if m.references != nil {
		edges = append(edges, book.EdgeReferences)
	}
	return edges
}
...
func (m *BookMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case book.EdgeReferees:
		ids := make([]ent.Value, 0, len(m.referees))
		for id := range m.referees {
			ids = append(ids, id)
		}
		return ids
	case book.EdgeReferences:
