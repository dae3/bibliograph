...
func HasReferees() predicate.Book {
...
func HasRefereesWith(preds ...predicate.Book) predicate.Book {
	return predicate.Book(func(s *sql.Selector) {
		step := newRefereesStep()
...
func HasReferences() predicate.Book {
	return predicate.Book(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasReferencesWith(preds ...predicate.Book) predicate.Book {
	return predicate.Book(func(s *sql.Selector) {
