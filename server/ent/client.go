...
// QueryReferees queries the referees edge of a Book.
func (c *BookClient) QueryReferees(b *Book) *BookQuery {
...
// QueryReferences queries the references edge of a Book.
func (c *BookClient) QueryReferences(b *Book) *BookQuery {
	query := (&BookClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := b.ID
		step := sqlgraph.NewStep(
